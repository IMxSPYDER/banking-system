...
const CustomerRegistration = () => {
  ...
  {/* Left Panel */}
  <div className="w-1/2 h-[100vh] bg-blue-800 text-white p-12 flex flex-col justify-center">
    <Link to="/" className="inline-flex items-center text-white hover:text-grey-700 mb-6">
            <ArrowLeft size={16} className="mr-1" />
            Back to Home
    </Link>
    <h1 className="text-3xl flex items-center gap-4 font-bold mb-4"> <Landmark size={36}/> Welcome to SecureBank</h1>
    <p className="text-lg">
      SecureBank our mission is to provide a safe and seamless banking experience for individuals and businesses alike. With advanced encryption, multi-factor authentication, and real-time monitoring, your data and transactions are always protected. Join thousands who trust SecureBank for secure, smart, and stress-free banking.
    </p>
  </div>

  {/* Right Panel with centered card */}
  <div className="w-1/2 bg-gray-50 flex items-center justify-center p-12 overflow-y-auto">
