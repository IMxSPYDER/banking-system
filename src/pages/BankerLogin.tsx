...
const BankerLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const data = await loginUser(email, password, 'banker');
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-md mx-auto pt-12 pb-16 px-4">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-1">Banker Login</h1>
          <p className="text-gray-600">Access banker portal</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <div className="mt-6 text-center text-gray-600">
            <Link to="/customer/login" className="text-blue-800 hover:text-blue-900 font-medium">
